...
class QMainWindow(QModelMainWindow, widgets.BackendMainWindow[QtW.QWidget]):
    ...
    def set_widget_as_preview(self, subwindow: SubWindow, is_preview: bool):
        qsubwindow = get_subwindow(subwindow._split_interface_and_frontend()[1])
        qsubwindow._title_bar._model_menu_btn.setHidden(is_preview)
        qsubwindow._title_bar._window_menu_btn.setHidden(is_preview)
